...
class DomainModelFilesService:
    ...
    @staticmethod
    def read_from_directory(project_root: str, ignore_patterns: Optional[List[str]] = None) -> DomainModelFiles:
        """
    ...
    @staticmethod
    def write_to_directory(domain_model: DomainModelFiles, project_root: str, create_dirs: bool = True) -> None:
        """
