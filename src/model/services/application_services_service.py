...
class ApplicationServicesService:
    ...
    @staticmethod
    def read_from_directory(project_root: str, ignore_patterns: Optional[List[str]] = None) -> ApplicationServices:
        """
    ...
    @staticmethod
    def write_to_directory(app_services: ApplicationServices, project_root: str, create_dirs: bool = True) -> None:
        """
